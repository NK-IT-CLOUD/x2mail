<div class="section" id="x2mail-wizard">
	...
	<h2><?php echo($l->t('Domain')); ?></h2>
	<div class="wizard-grid">
		<label for="wiz-domain"><?php echo($l->t('Mail Domain')); ?></label>
		<input type="text" id="wiz-domain" placeholder="example.com" title="<?php echo($l->t('Part after @ in user email addresses')); ?>">

		<label for="wiz-auth-type"><?php echo($l->t('Auth Type')); ?></label>
		<select id="wiz-auth-type">
			<option value="oauth" selected>SSO (OAuth2)</option>
	...
	<h2>IMAP</h2>
	<div class="wizard-grid">
		<label for="wiz-imap-host"><?php echo($l->t('Host')); ?></label>
		<input type="text" id="wiz-imap-host" placeholder="mail.example.com">

		<label for="wiz-imap-port"><?php echo($l->t('Port')); ?></label>
		<input type="number" id="wiz-imap-port" value="143" min="1" max="65535">

		<label for="wiz-imap-ssl"><?php echo($l->t('Security')); ?></label>
	...
	<h2>SMTP</h2>
	<div class="wizard-grid">
		<label for="wiz-smtp-host"><?php echo($l->t('Host')); ?></label>
		<input type="text" id="wiz-smtp-host" placeholder="<?php echo($l->t('same as IMAP')); ?>">

		<label for="wiz-smtp-port"><?php echo($l->t('Port')); ?></label>
		<input type="number" id="wiz-smtp-port" value="25" min="1" max="65535">

		<label for="wiz-smtp-ssl"><?php echo($l->t('Security')); ?></label>
	...
	<div class="wizard-actions">
		...
		<button id="wiz-delete-btn" class="button" style="display:none"><?php echo($l->t('Delete Configuration')); ?></button>
