...
; Please don\'t add custom parameters here, those will be overwritten',
	...
	public function SetPassword(\X2Mail\Engine\SensitiveString $oPassword) : void
	{
		$this->Set('security', 'admin_password', \password_hash($oPassword, PASSWORD_DEFAULT));
	}

	public function ValidatePassword(\X2Mail\Engine\SensitiveString $oPassword) : bool
	{
...
Warning: only enable when server does not do this, else double compression errors occur')
			...
			'contacts' => array(
				...
				'allow_sync'        => array(true),
				'sync_interval'     => array(20),
				'type'              => array('sqlite'),
				'pdo_dsn'           => array('host=127.0.0.1;port=3306;dbname=x2mail'),
				'pdo_user'          => array('root'),
				'pdo_password'      => array(''),
...
'),
				...
				'sign_me_auto' => array(\X2Mail\Engine\Enumerations\SignMeType::Unused,
					'Unused for SSO'),
