...
CREATE TABLE IF NOT EXISTS x2mail_ab_contacts (
	...
	INDEX id_user_x2mail_ab_contacts_index (id_user)

) ENGINE=INNODB CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS x2mail_ab_properties (
	...
	PRIMARY KEY(id_prop),
	INDEX id_user_x2mail_ab_properties_index (id_user),
	INDEX id_user_id_contact_x2mail_ab_properties_index (id_user, id_contact),
	INDEX id_contact_prop_type_x2mail_ab_properties_index (id_contact, prop_type)
...
CREATE TABLE x2mail_ab_contacts (
...
CREATE INDEX id_user_x2mail_ab_contacts_index ON x2mail_ab_contacts (id_user);

CREATE TABLE x2mail_ab_properties (
...
CREATE INDEX id_user_x2mail_ab_properties_index ON x2mail_ab_properties (id_user);
CREATE INDEX id_user_id_contact_x2mail_ab_properties_index ON x2mail_ab_properties (id_user, id_contact);
		...
		switch ($sDbType)
		{
			case 'mysql':
				$aVersions = [
					1 => [],
					2 => [
'ALTER TABLE x2mail_ab_properties ADD prop_value_lower MEDIUMTEXT NOT NULL AFTER prop_value_custom;'
					],
					3 => [
'ALTER TABLE x2mail_ab_properties CHANGE prop_value prop_value MEDIUMTEXT NOT NULL;',
'ALTER TABLE x2mail_ab_properties CHANGE prop_value_custom prop_value_custom MEDIUMTEXT NOT NULL;',
'ALTER TABLE x2mail_ab_properties CHANGE prop_value_lower prop_value_lower MEDIUMTEXT NOT NULL;'
					],
					4 => [
'ALTER TABLE x2mail_ab_properties CHANGE prop_value prop_value MEDIUMTEXT NOT NULL;',
'ALTER TABLE x2mail_ab_properties CHANGE prop_value_custom prop_value_custom MEDIUMTEXT NOT NULL;',
'ALTER TABLE x2mail_ab_properties CHANGE prop_value_lower prop_value_lower MEDIUMTEXT NOT NULL;'
			...
			case 'pgsql':
				$aVersions = [
					1 => [],
					2 => [
'ALTER TABLE x2mail_ab_properties ADD prop_value_lower text NOT NULL DEFAULT \'\';'
					]
				];
				break;
