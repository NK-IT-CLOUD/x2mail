...
class Header implements \JsonSerializable
{
	...
	public static function NewInstanceFromEncodedString(string $sEncodedLines, string $sIncomingCharset = \X2Mail\Mail\Base\Enumerations\Charset::ISO_8859_1) : Header
	{
		if (empty($sIncomingCharset)) {
			$sIncomingCharset = \X2Mail\Mail\Base\Enumerations\Charset::ISO_8859_1;
		}
...
//					'scheme' => \X2Mail\Mail\Base\Enumerations\Encoding::QUOTED_PRINTABLE_SHORT,
					'scheme' => \X2Mail\Mail\Base\Enumerations\Encoding::BASE64_SHORT,
					'input-charset' => \X2Mail\Mail\Base\Enumerations\Charset::UTF_8,
					'output-charset' => \X2Mail\Mail\Base\Enumerations\Charset::UTF_8,
					'line-length' => 74,
					'line-break-chars' => "\r\n"
				));
			}
