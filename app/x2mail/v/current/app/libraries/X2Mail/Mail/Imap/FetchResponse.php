...
class FetchResponse
{
	...
	public function GetFetchEnvelopeEmailCollection(int $iIndex, string $sParentCharset = \X2Mail\Mail\Base\Enumerations\Charset::ISO_8859_1) : ?\X2Mail\Mail\Mime\EmailCollection
	{
		$oResult = null;
